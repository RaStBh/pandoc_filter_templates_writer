-- A  pandoc writer  for plain  output. It  is based  on the  default data  file
-- sample.lua.
--
...
--
-- Created using:
--   bash> pandoc --print-default-data-file sample.lua > ./rast-plain.lua
...
function Header(lev, s, attr)
  --return "<h" .. lev .. attributes(attr) ..  ">" .. s .. "</h" .. lev .. ">" -- RaSt
  return s
end
